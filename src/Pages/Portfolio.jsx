...
export default function Portfolio() {
  ...
  return (
    <section
      id="portfolio"
      className={`${styles.sectionLayout} sm:pl-12 xl:pl-40 xl:pr-40 mr:pt-20 mr:pl-8 mr:pr-8 mr:pb-10 md:pb-20 lg:pb-28 xl:pb-28`}
    >
      <div className={`${styles.aboutContent} `}>
        ...
        <div className="flex flex-col gap-y-10 sm:pr-12">
          {projects.map((project) => (
            <div
              key={project.id}
              className={`${styles.card} flex p-8 gap-x-8 rounded-lg sm:flex-col sm:gap-y-4 lg:flex-row mr:flex-col mr:gap-y-8`}
            >
              <div>
              ...
              <div>
                <h1 className="text-2xl mb-2">{project.projectName}</h1>
                <p className={`${styles.paraColor} text-sm leading-7 mb-4`}>
                  {project.details}
                </p>
